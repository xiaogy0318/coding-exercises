'''
Python Tree Test
This is python test to see if the interviewee can manipulate tree data structures from files.
The interviewee will be require to: - Open/read python files; - Do light parsing; - Use python data structures like dict to build a a tree and then infer information from the tree.
Python 2 Created by Joe Triscari a year ago
#Interviewee should skip this top part the question is below
'''
